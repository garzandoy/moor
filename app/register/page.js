      ...
      <div className="relative z-10 bg-gradient-to-br from-[#1a1625] to-[#2d1f3d] rounded-2xl shadow-2xl max-w-md w-full p-8 border border-[#8B1538]/30">
        ...
        <div className="text-center mb-6">
          <div className="flex items-center justify-center gap-2 mb-3">
            ...
            />
            <span className="font-bold text-2xl text-white">Puhanah</span>
          </div>
          <p className="text-sm text-[#D4AF37] font-semibold flex items-center justify-center gap-1.5">
        ...
        <div className="mt-6 text-center text-xs text-white/40">
          By signing up to Puhanah, you agree to our{' '}
