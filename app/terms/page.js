      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
        <div className="prose prose-lg max-w-none">
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700">
              By using the Service, you represent and warrant that you meet the eligibility requirements and have the legal capacity to enter into these Terms.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700">
              We reserve the right to suspend or terminate your account at any time for any reason, including if you violate these Terms.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 mb-4">
              The Service and its original content, features, and functionality are owned by Puhana and are protected by international copyright, trademark, patent, trade secret, and other intellectual property laws.
            </p>

            <h3 className="text-xl font-semibold text-gray-900 mb-3">5.2 License to Use</h3>
            <p className="text-gray-700 mb-4">
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-3">5.3 Your Content</h3>
            <p className="text-gray-700">
              You retain ownership of any content you submit to the Service. By submitting content, you grant us a worldwide, non-exclusive, royalty-free license to use, reproduce, and display your content in connection with operating the Service.
            </p>
          </section>

          {/* Free Service */}
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-4">6. Free Service and Future Pricing</h2>
            <p className="text-gray-700 mb-4">
              Puhana currently offers free access to all features. We reserve the right to:
            </p>
            <ul className="list-disc pl-6 text-gray-700 mb-4 space-y-2">
              <li>Introduce paid subscription plans in the future</li>
              <li>Limit certain features to paid subscribers</li>
              <li>Change pricing at any time with advance notice</li>
            </ul>
            <p className="text-gray-700">
              If we introduce paid plans, we will provide notice and you will have the option to upgrade or continue using any available free tier.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700">
              We do not guarantee that you will achieve any particular learning outcomes by using the Service.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 mb-4">
              TO THE MAXIMUM EXTENT PERMITTED BY LAW, PUHANA SHALL NOT BE LIABLE FOR:
            </p>
            <ul className="list-disc pl-6 text-gray-700 mb-4 space-y-2">
              <li>Any indirect, incidental, special, consequential, or punitive damages</li>
              <li>Loss of profits, revenue, data, or use</li>
              <li>Any damages arising from your use or inability to use the Service</li>
              <li>Any damages resulting from unauthorized access to your account or data</li>
            </ul>
            <p className="text-gray-700">
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700">
              The Service may contain links to third-party websites or services. We are not responsible for the content, privacy policies, or practices of any third-party sites. You acknowledge and agree that we shall not be liable for any damage or loss caused by your use of any third-party services.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 mb-4">
              We may suspend or terminate your access to the Service immediately, without notice, for any reason, including if you:
            </p>
            <ul className="list-disc pl-6 text-gray-700 mb-4 space-y-2">
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700">
              Any disputes arising from these Terms or the Service shall be resolved in the courts of Ontario, Canada. You irrevocably consent to the exclusive jurisdiction and venue of such courts.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700">
              These Terms, together with our Privacy Policy, constitute the entire agreement between you and Puhana regarding the Service and supersede all prior agreements and understandings.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <ul className="list-none text-gray-700 space-y-2">
              <li><strong>Email:</strong> legal@puhanah.com</li>
