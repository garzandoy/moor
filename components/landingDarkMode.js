...
export default function DarkMode() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold text-white mb-5 leading-tight">
                Master Pashto,
                <span className="bg-gradient-to-r from-[#D4AF37] to-amber-400 bg-clip-text text-transparent"> One Lesson</span> at a Time
              </h1>
      ...
      {/* Stats Section - CHANGED: No red background */}
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li><button onClick={() => setShowLoginModal(true)} className="text-slate-400 hover:text-white transition-colors">Login</button></li>
              </ul>
            </div>
...
function LoginModal({ onClose }) {
  ...
  return (
    <div className="fixed inset-0 bg-black/70 backdrop-blur-sm z-50 flex items-center justify-center p-4 animate-fade-in">
      <div className="bg-gradient-to-br from-[#1a1625] to-[#2d1f3d] rounded-2xl shadow-2xl max-w-md w-full p-8 relative animate-slide-up border border-[#8B1538]/30">
        <button
          onClick={onClose}
