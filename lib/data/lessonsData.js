  ...
  'basic-greetings': {
    ...
    exercises: [
      ...
      // Listen and select
      {
        ...
        audio: '/audio/salaam.mp3',
        options: [
          { text: 'Hello', translation: 'سلام' },
          { text: 'Thank you', translation: 'مننه' },
          { text: 'Goodbye', translation: 'په مخه دې ښه' }
        ],
        correct: 0,
        explanation: 'You heard سلام (salaam) - Hello'
      },
      ...
      // Match pairs
      {
        ...
        pairs: [
          { pashto: 'سلام', english: 'Hello' },
          { pashto: 'څنګه یاست؟', english: 'How are you?' }
        ]
      },
  ...
  'asking-names': {
    ...
    exercises: [
      ...
      // Choose appropriate form
      {
        ...
        instruction: 'You meet your teacher. Which word for "you"?',
      ...
      {
        type: 'scenario-choice',
        instruction: 'You meet your classmate. Which word for "you"?',
      ...
      {
        type: 'match-pairs',
        instruction: 'Match formal and informal',
        pairs: [
          { pashto: 'ستا (informal)', english: 'Your' },
          { pashto: 'ستاسو (formal)', english: 'Your (respectful)' },
          { pashto: 'ته (informal)', english: 'You' },
          { pashto: 'تاسو (formal)', english: 'You (respectful)' }
        ]
      },
      ...
      // Practice scenario
      {
        ...
        context: 'You meet your friend\'s grandmother',
        dialogue: [
          { speaker: 'You', text: 'سلام!', english: 'Hello!' },
          { speaker: 'You', text: '___', english: '' }
        ],
      ...
      // Practice scenario 2
      {
        type: 'fill-conversation',
        instruction: 'Complete the conversation',
        context: 'You meet a new classmate',
        dialogue: [
          { speaker: 'You', text: 'سلام! زما نوم علی دی.', english: 'Hello! My name is Ali.' },
          { speaker: 'You', text: '___', english: '' }
        ],
